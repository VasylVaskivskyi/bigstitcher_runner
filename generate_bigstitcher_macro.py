...
class BigStitcherMacro:
    def __init__(self):
        ...
        self.pattern = '1_{xxxxx}_Z{ttt}_CH{ccc}.tif'
    ...
    def read_macro_template(self):
        macro_template_file = osp.join(self.__location, 'bigstitcher_macro_template.ijm')
    ...
    def write_to_temp_macro_file(self, formatted_macro):
        ...
        macro_file_path = osp.join(self.__location, 'bigstitcher_macro.ijm')
